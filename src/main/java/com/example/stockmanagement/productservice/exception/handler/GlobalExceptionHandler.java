    ...
    public InternalApiResponse<String> handleProductNotFoundException(ProductNotFoundException productNotFoundException){
        return InternalApiResponse.<String>builder()
                .friendlyMessage(FriendlyMessage.builder()
                        ...
                        .description(FriendlyMessageUtils.getFriendlyMessage(productNotFoundException.getLanguage(), productNotFoundException.getIFriendlyMessageCode()))
                        .build())
                .httpStatus(HttpStatus.NOT_FOUND)
                .hasError(true)
                .errorMessage(Collections.singletonList(productNotFoundException.getMessage()))
                .build();
    }
    ...
    public InternalApiResponse<String> handleProductAlreadyDeletedException(ProductAlreadyDeletedException productAlreadyDeletedException){
        return InternalApiResponse.<String>builder()
                .friendlyMessage(FriendlyMessage.builder()
                        ...
                        .description(FriendlyMessageUtils.getFriendlyMessage(productAlreadyDeletedException.getLanguage(), productAlreadyDeletedException.getIFriendlyMessageCode()))
                        .build())
                .httpStatus(HttpStatus.BAD_REQUEST)
                .hasError(true)
                .errorMessage(Collections.singletonList(productAlreadyDeletedException.getMessage()))
                .build();
    }
}
